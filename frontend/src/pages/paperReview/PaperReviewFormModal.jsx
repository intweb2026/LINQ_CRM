    ...
    <Modal size="full" title={isNew ? 'New paper review' : 'Edit paper review'}
      ...
      <div className="fs">
        ...
        <div className="fg c4">
          ...
          <div className="fd"><label className="fd-l">LinkedIn followers count<span className="req">*</span></label><input className="in" type="number" value={form.linkedin_followers} onChange={set('linkedin_followers')} /></div>
        ...
        <div className="fg c4">
          {PAPER_REVIEW_CRITERIA.map((c) => (
            <div className="fd" key={c.key}>
              ...
              <input className="in" type="number" min={0} max={c.max} value={form[c.key]} onChange={set(c.key)} />
            </div>
          ))}
          <div className="fd">
          ...
          <div className="fd">
            <label className="fd-l">Grade</label>
