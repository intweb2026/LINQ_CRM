...
export default function UserDrawer({ user: u, onClose, onChanged }) {
  ...
  return (
    <Drawer
      ...
      foot={<>
        ...
        {can('update', 'users') ? <>
          <button className="btn btn-s" onClick={() => toast('Password reset link sent to ' + u.email, 'ok')}><Icon name="key" size={15} />Reset password</button>
