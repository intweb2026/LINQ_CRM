...
export function reportingManagerOf(user, teams, users) {
  ...
  // lead. Administrators are who is left.
 ...
 *
 * Two groups, because they are different kinds of answer: the leads of the
 * person's own team, and the administrators. Both are offered for everyone —
 * a team lead has no lead above them and would otherwise have nothing to pick.
 */
